        ...
        <footer className="bg-slate-900 text-gray-300">
            <div className="container mx-auto px-4 py-12">
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="text-gray-400 mb-4 max-w-md">
                            Desarrollador Web Full Stack. Creo sitios que hacen crecer tu negocio.
                        </p>

                        {/* CTA destacado en footer */}
                        <a
                            href={whatsappLink}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-all duration-300 shadow-lg hover:scale-105"
                        >
                ...
                <div className="pt-8 border-t border-slate-800 text-center text-sm text-gray-500">
                    <p>
                        © {currentYear} {personalInfo.name}. Hecho con Next.js & Tailwind CSS
                    </p>
                </div>
            </div>
        </footer>
